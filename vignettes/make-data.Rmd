...
The MS acquision was started 18 min post sample injection and lastet only 4 min. Be aware that spray voltage and source gas was turned on at 18.5 min (see Tunefiles section of the method). This means the first 30 s were recorded
...
|    software          |    release              |
|:---------------------|:------------------------|
|ProteoWizard          | 3.0.10200 (2016-11-17)  |
...
aws --profile AnnotationContributor s3 cp tartare/F255744.RData s3://annotation-contributor/NestLink/F255744.RData --acl public-read

aws --profile AnnotationContributor s3 cp tartare/WU160118.RData s3://annotation-contributor/tartare/WU160118.RData --acl public-read

aws --profile AnnotationContributor s3 cp NestLink s3://annotation-contributor/tartare --recursive --acl public-read
